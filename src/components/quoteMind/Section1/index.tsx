...
const HeroSection: React.FC = () => {
  return (
    <section className="min-h-fit flex flex-col items-center justify-center text-center">
      ...
      <div className="relative top-18 mt-8 w-full max-w-full md:max-w-5xl px-4 md:px-8 hidden md:block">
        ...
        <HeroBg4Icon className="absolute top-0 -right-22 w-16 h-16 md:w-24 md:h-24 lg:w-32 lg:h-32 flex-shrink-0 z-10 animate-bounce" />
      </div>
    </section>
  );
};
